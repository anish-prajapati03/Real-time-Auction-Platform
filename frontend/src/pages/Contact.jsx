          ...
          >
            ...
            <div className="flex flex-col gap-2">
              ...
              <input
                ...
                className="w-full mt-1 p-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#8458B3]"
                required
              />
            </div>
            <div className="flex flex-col gap-2">
            ...
            <button
              className="bg-[#8458B3] mx-auto font-semibold hover:bg-[#422C59] text-xl transition-all duration-300 py-2 px-4 rounded-md text-white my-4"
              type="submit"
            >
